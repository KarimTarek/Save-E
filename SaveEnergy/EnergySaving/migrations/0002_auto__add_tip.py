...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tip'
        db.create_table('EnergySaving_tip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('EnergySaving', ['Tip'])


    def backwards(self, orm):
        # Deleting model 'Tip'
        db.delete_table('EnergySaving_tip')
    ...
    models = {
        ...
        'EnergySaving.user': {
            ...
            'badge': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['EnergySaving.Badge']", 'null': 'True', 'blank': 'True'}),
