...
\begin{figure}[H]
\centring
\includegraphics[width=0.85\textwidth]{Example19.png}
...
\\
\newline 1. Login.
\newline 2. State your level.
\newline 3. State the amount of money you have.
\newline 4. State the badges that you've won.
\newline 5. State the tip of the day.
\newline 6. State your rank on the leader board.
\newline 7. View your total energy usage:
\newline - State in () the amount of energy your display used in total.
\newline 8. View your energy usage from 1-August to 1-October:
\newline - State in () the amount of energy your CPU used in total.
\newline 9. Assume that a stranger suddenly appeared try to hide your data.
\newline 10.Logout.
