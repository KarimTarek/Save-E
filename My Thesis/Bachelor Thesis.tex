...
Energy is now one of the main concerns the world is concerned about , since energy resources are running out and people's energy consumption is increasing dramatically it was expected that from 2008 to 2030 world energy consumption is expected to increase more than 55\% (Refer here). Moreover energy consumption increase the rate of Carbon dioxide (CO2) in our environment which then leads to global warming and other environmental problems.
\\
...
\\
\newline \noindent So the SUS score for the application was calculated from the results explained above by collecting the average scores of all the participants and then for the positively-worded items (1,3,5,7 and 9) the score was the number users chose - one and the rest of the questions (2,4,6,8 and 10) it was five - the number the user chose then summing them all and multiplying by 2.5 at the end it gave us a SUS score of 76 so according to the graph below it corresponds to a B grade.
