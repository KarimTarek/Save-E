...
\\
\newline \noindent So the SUS score for the application was calculated from the results explained above by collecting the average scores of all the participants and then for the positively-worded items (1,3,5,7 and 9) the score was the number users chose minus one and the rest of the questions (2,4,6,8 and 10) it was five minus the number the user chose then summing them all and multiplying by 2.5 at the end it gave us a SUS score of 76 so according to the graph below in figure~\ref{fig:SusScore}\footnote[1]{http://www.measuringusability.com/sus.php} it corresponds to a B grade.
